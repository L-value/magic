...
public class RoundedImageView extends ImageView {
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        int index = a.getInt(R.styleable.RoundedImageView_android_scaleType,
                -1);
        if (index >= 0) {
        ...
        cornerRadius = a.getDimensionPixelSize(R.styleable.RoundedImageView_corner_radius,
                -1);
        borderWidth = a.getDimensionPixelSize(R.styleable.RoundedImageView_border_width,
                -1);
        ...
        mutateBackground = a.getBoolean(R.styleable.RoundedImageView_mutate_background,
                false);
